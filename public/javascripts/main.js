...
var _connexity$ksql_web$Ksql_Common$ksqlCommandJson = F2(
						...
						_1: _elm_lang$core$Json_Encode$object(
							_elm_lang$core$Dict$toList(
								A2(
									...
									F2(
										function (_p0, value) {
											return _elm_lang$core$Json_Encode$string(value);
										}),
									props)))
					},
					_1: {ctor: '[]'}
...
var _connexity$ksql_web$Ksql_Common$sendQuery = F3(
	function (flags, props, query) {
		return A2(
			...
			A2(
				...
				0,
				A2(_connexity$ksql_web$Ksql_Common$ksqlCommandJson, props, query)));
	});
...
var _connexity$ksql_web$Ksql_Common$Model = F7(
	function (a, b, c, d, e, f, g) {
		return {flags: a, state: b, properties: c, query: d, result: e, notifications: f, errorMessages: g};
	});
...
var _connexity$ksql_web$Ksql_Common$PropertiesResult = function (a) {
	return {ctor: 'PropertiesResult', _0: a};
};
...
var _connexity$ksql_web$Ksql_Init$initProperties = _elm_lang$core$Dict$fromList(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'application.id', _1: 'ksql-web'},
		_1: {ctor: '[]'}
	});
var _connexity$ksql_web$Ksql_Init$init = function (flags) {
	return {
		...
		_0: A7(
			...
			_connexity$ksql_web$Ksql_Init$initProperties,
			A3(
						...
						if (((_p1.ctor === '_Tuple2') && (_p1._0 === true)) && (_p1._1.ctor === 'Just')) {
							return function (_p2) {
								return A2(
									...
									A3(_connexity$ksql_web$Ksql_Common$sendQuery, flags, _elm_lang$core$Dict$empty, _p1._1._0),
									_connexity$ksql_web$Ksql_Common$Running(
										A2(_connexity$ksql_web$Ksql_Common$DeterminateProgress, 0, _p2)));
							};
						} else {
							return function (_p3) {
								return A2(
									...
									_connexity$ksql_web$Ksql_Common$Initializing(
										A2(_connexity$ksql_web$Ksql_Common$DeterminateProgress, 0, _p3)));
							};
						}
					}(),
...
var _connexity$ksql_web$Ksql_Update$unescapeSqlString = A3(
...
var _connexity$ksql_web$Ksql_Update$escapeSqlString = A3(
	_elm_lang$core$Regex$replace,
	_elm_lang$core$Regex$All,
	_elm_lang$core$Regex$regex('\''),
	function (_p1) {
...
var _connexity$ksql_web$Ksql_Update$unsetStatementRegex = _elm_lang$core$Regex$caseInsensitive(
	_elm_lang$core$Regex$regex('^UNSET\\W+\'((?:[^\']|\'\')+)\';$'));
var _connexity$ksql_web$Ksql_Update$setStatementRegex = _elm_lang$core$Regex$caseInsensitive(
	_elm_lang$core$Regex$regex('^SET\\W+\'((?:[^\']|\'\')+)\'\\W*=\\W*\'((?:[^\']|\'\')*)\';$'));
...
var _connexity$ksql_web$Ksql_Update$PropertiesResponse = function (a) {
	return {ctor: 'PropertiesResponse', _0: a};
};
...
var _connexity$ksql_web$Ksql_Update$responseDecoder = function () {
	...
	var curStatusDecoder = function () {
		...
		return A2(
			...
			function (_p2) {
				var _p3 = _p2;
				var _p4 = _p3._1;
				return _p3._0 ? _connexity$ksql_web$Ksql_Update$NotificationMessageResponse(_p4) : _connexity$ksql_web$Ksql_Update$ErrorMessageResponse(_p4);
			},
			currentStatusObjectDecoder);
	}();
	var propertiesRespDecoder = function () {
		var valueDecoder = _elm_lang$core$Json_Decode$oneOf(
			{
				ctor: '::',
		...
		return A2(_elm_lang$core$Json_Decode$map, _connexity$ksql_web$Ksql_Update$PropertiesResponse, propertiesObjectDecoder);
	}();
	var columnDecoder = function () {
		...
		var numericColumnDecoder = A2(_elm_lang$core$Json_Decode$map, _connexity$ksql_web$Ksql_Common$NumericColumn, _elm_lang$core$Json_Decode$float);
				...
				switch (_p15) {
					...
					default:
						return _elm_lang$core$Json_Decode$fail(
							A2(_elm_lang$core$Basics_ops['++'], 'Unhandled ksqlWeb message: ', _p15));
				}
			},
	...
	function (msg, model) {
		...
		switch (_p16.ctor) {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							query: _elm_lang$core$Native_Utils.update(
								query,
								{
									editBuffers: A3(_elm_lang$core$Dict$insert, query.currentHistoryIndex, _p16._0, query.editBuffers)
								})
						}),
			...
			case 'RunQuery':
				...
				var resetModel = _elm_lang$core$Native_Utils.update(
					model,
					{
				...
				if (_elm_lang$core$String$isEmpty(queryText)) {
					return {ctor: '_Tuple2', _0: resetModel, _1: _elm_lang$core$Platform_Cmd$none};
				} else {
					if (A2(
						_elm_lang$core$String$startsWith,
						'SET ',
						_elm_lang$core$String$toUpper(queryText))) {
						var _p17 = A2(
							_elm_lang$core$List$map,
							function (_) {
								return _.submatches;
							},
							A3(_elm_lang$core$Regex$find, _elm_lang$core$Regex$All, _connexity$ksql_web$Ksql_Update$setStatementRegex, queryText));
						if (((((((_p17.ctor === '::') && (_p17._0.ctor === '::')) && (_p17._0._0.ctor === 'Just')) && (_p17._0._1.ctor === '::')) && (_p17._0._1._0.ctor === 'Just')) && (_p17._0._1._1.ctor === '[]')) && (_p17._1.ctor === '[]')) {
							var _p19 = _p17._0._1._0._0;
							var _p18 = _p17._0._0._0;
							var prop = _connexity$ksql_web$Ksql_Update$unescapeSqlString(_p18);
							return {
								ctor: '_Tuple2',
								_0: _elm_lang$core$Native_Utils.update(
									resetModel,
									{
										properties: A3(
											_elm_lang$core$Dict$insert,
											prop,
											_connexity$ksql_web$Ksql_Update$unescapeSqlString(_p19),
											model.properties),
										notifications: {
											ctor: '::',
											_0: A2(
												_elm_lang$core$Basics_ops['++'],
												'Successfully changed local property \'',
												A2(
													_elm_lang$core$Basics_ops['++'],
													_p18,
													A2(
														...
														A2(
															_elm_lang$core$Basics_ops['++'],
															_connexity$ksql_web$Ksql_Update$escapeSqlString(
																A2(
																	_elm_lang$core$Maybe$withDefault,
																	'',
																	A2(_elm_lang$core$Dict$get, prop, model.properties))),
															A2(
																_elm_lang$core$Basics_ops['++'],
																'\' to \'',
								...
								_1: _connexity$ksql_web$Ksql_Port$localStorageGetQueryHistoryCmd(
									{ctor: '_Tuple0'})
							};
						} else {
							return {
								...
								_0: _elm_lang$core$Native_Utils.update(
									resetModel,
									{
										errorMessages: {
											ctor: '::',
											_0: 'Syntax error in SET statement, correct syntax is \nSET \'...\'=\'...\';',
											_1: {ctor: '[]'}
										}
									}),
								_1: _elm_lang$core$Platform_Cmd$none
						...
						if (A2(
							...
							var _p20 = A2(
								...
								A3(_elm_lang$core$Regex$find, _elm_lang$core$Regex$All, _connexity$ksql_web$Ksql_Update$unsetStatementRegex, queryText));
							if (((((_p20.ctor === '::') && (_p20._0.ctor === '::')) && (_p20._0._0.ctor === 'Just')) && (_p20._0._1.ctor === '[]')) && (_p20._1.ctor === '[]')) {
								var _p21 = _p20._0._0._0;
								var prop = _connexity$ksql_web$Ksql_Update$unescapeSqlString(_p21);
								return {
									ctor: '_Tuple2',
									_0: _elm_lang$core$Native_Utils.update(
										resetModel,
										{
											properties: A2(_elm_lang$core$Dict$remove, prop, model.properties),
											notifications: {
												ctor: '::',
												_0: A2(
													_elm_lang$core$Basics_ops['++'],
													'Successfully unset local property \'',
													A2(
														_elm_lang$core$Basics_ops['++'],
														_p21,
														A2(
								...
								return {
									...
									_0: _elm_lang$core$Native_Utils.update(
										resetModel,
										{
											errorMessages: {
												ctor: '::',
												_0: 'Syntax error in UNSET statement, correct syntax is:\nUNSET \'...\';',
												_1: {ctor: '[]'}
											}
										}),
									_1: _elm_lang$core$Platform_Cmd$none
								...
								_1: _elm_lang$core$Platform_Cmd$batch(
									{
										...
										_0: A2(
											...
											function (_p22) {
												return A2(
													_connexity$ksql_web$Ksql_Common$PerformInTimedState,
													A3(_connexity$ksql_web$Ksql_Common$sendQuery, model.flags, model.properties, queryText),
													_connexity$ksql_web$Ksql_Common$Running(
														A2(_connexity$ksql_web$Ksql_Common$DeterminateProgress, 0, _p22)));
											},
											_elm_lang$core$Time$now),
										_1: {
											ctor: '::',
			...
			case 'PauseQuery':
				var updatedState = function () {
					...
					if (_p23.ctor === 'Streaming') {
						return A2(_connexity$ksql_web$Ksql_Common$Streaming, !_p23._0, _p23._1);
					} else {
						return _p23;
					}
				}();
				var updatedCmd = function () {
					var _p24 = updatedState;
					if ((_p24.ctor === 'Streaming') && (_p24._0 === true)) {
						return _connexity$ksql_web$Ksql_Update$scrollToBottom;
					} else {
						return _elm_lang$core$Platform_Cmd$none;
					}
				}();
				var _p25 = model.result;
				_v9_2:
				do {
					if (_p25.ctor === 'Just') {
						switch (_p25._0.ctor) {
										...
										model,
										{
											...
											result: _elm_lang$core$Maybe$Just(
												_connexity$ksql_web$Ksql_Common$StreamingTabularResult(
													_connexity$ksql_web$Stream$togglePause(_p25._0._0)))
										}),
									_1: updatedCmd
								};
			...
			case 'UpdateQueryHistory':
				...
				var updatedQueryHistory = function () {
					...
					if (_p26.ctor === '[]') {
						...
						return _elm_lang$core$Native_Utils.eq(_p26._0, queryText) ? _p27 : A2(
							_elm_lang$core$List$take,
							_connexity$ksql_web$Ksql_Update$maxQueryHistoryItems,
							{ctor: '::', _0: queryText, _1: _p27});
					}
				}();
				return {
					ctor: '_Tuple2',
			...
			case 'WebSocketIncoming':
				...
				return {
										...
										switch (_p29.ctor) {
											...
											case 'TableResponse':
												return _elm_lang$core$Native_Utils.update(
													model,
													{
														state: _connexity$ksql_web$Ksql_Common$Idle,
														result: _elm_lang$core$Maybe$Just(
															_connexity$ksql_web$Ksql_Common$TabularResult(_p29._0))
													});
											...
											case 'PropertiesResponse':
												return _elm_lang$core$Native_Utils.update(
													model,
													{
														state: _connexity$ksql_web$Ksql_Common$Idle,
														result: _elm_lang$core$Maybe$Just(
															_connexity$ksql_web$Ksql_Common$PropertiesResult(_p29._0))
													});
											case 'DescribeExtendedResponse':
												return _elm_lang$core$Native_Utils.update(
													model,
													{
														state: _connexity$ksql_web$Ksql_Common$Idle,
														result: _elm_lang$core$Maybe$Just(
															_connexity$ksql_web$Ksql_Common$DescribeExtendedResult(_p29._0))
													});
											case 'ExplainResponse':
												return _elm_lang$core$Native_Utils.update(
													model,
													{
														state: _connexity$ksql_web$Ksql_Common$Idle,
														result: _elm_lang$core$Maybe$Just(
															_connexity$ksql_web$Ksql_Common$ExplainResult(_p29._0))
													});
											case 'MetaRawContentFollows':
												var lines = function () {
													var _p33 = model.result;
													if ((_p33.ctor === 'Just') && (_p33._0.ctor === 'StreamingTextualResult')) {
														return _p33._0._0;
													} else {
														return A2(
															_connexity$ksql_web$Stream_ops[':::'],
															A2(_elm_lang$core$Basics_ops['++'], 'Format: ', _p29._0),
											...
											case 'StreamedTextResponse':
												...
												var lines = function () {
													...
													if ((_p35.ctor === 'Just') && (_p35._0.ctor === 'StreamingTextualResult')) {
														return _p35._0._0;
													} else {
														return _connexity$ksql_web$Stream$empty(_connexity$ksql_web$Ksql_Update$maxDisplayedRows);
													}
												...
												return _elm_lang$core$Native_Utils.update(
													model,
													{
														...
														result: _elm_lang$core$Maybe$Just(
															_connexity$ksql_web$Ksql_Common$StreamingTextualResult(
																A2(_connexity$ksql_web$Stream_ops[':::'], _p29._0, lines)))
													});
											default:
												var newErrorMessages = function () {
													var _p36 = _elm_lang$core$String$lines(_p29._0);
													if (_p36.ctor === '::') {
														return {ctor: '::', _0: _p36._0, _1: model.errorMessages};
													} else {
					...
					_1: function () {
						var _p37 = {ctor: '_Tuple2', _0: responsesResult, _1: model.state};
						_v20_2:
						do {
							if ((_p37.ctor === '_Tuple2') && (_p37._1.ctor === 'Streaming')) {
								if ((((_p37._0.ctor === 'Ok') && (_p37._0._0.ctor === '::')) && (_p37._0._0._0.ctor === 'MetaConnected')) && (_p37._0._0._1.ctor === '[]')) {
									return A3(
			...
			case 'ProgressTick':
				...
				return {
						...
						switch (_p39.ctor) {
							case 'Initializing':
								...
								var updatedProgress = _elm_lang$core$Native_Utils.update(
									_p40,
									{duration: (_p40.duration + _p45) - _p40.currentTime, currentTime: _p45});
								return _elm_lang$core$Native_Utils.update(
									model,
									{
							...
							case 'Running':
								...
								var updatedProgress = _elm_lang$core$Native_Utils.update(
									_p41,
									{duration: (_p41.duration + _p45) - _p41.currentTime, currentTime: _p45});
								return _elm_lang$core$Native_Utils.update(
									model,
									{
							...
							case 'Streaming':
								...
								var updatedProgress = function () {
									var duration = _p45 - _p43.currentTime;
									var markerDurations = (!_p42) ? _p43.markerDurations : A2(
										_elm_lang$core$List$map,
										F2(
											function (x, y) {
												return x + y;
											})(duration),
										_p43.markerDurations);
									return _elm_lang$core$Native_Utils.update(
										_p43,
										{markerDurations: markerDurations, currentTime: _p45});
								}();
								return _elm_lang$core$Native_Utils.update(
									model,
									{
										state: A2(_connexity$ksql_web$Ksql_Common$Streaming, _p42, updatedProgress)
									});
							default:
								return model;
						}
					...
					_1: function () {
						...
						if ((_p44.ctor === 'Streaming') && (_p44._0 === true)) {
							return A2(
								_elm_lang$core$Random$generate,
			...
			case 'ProgressAddRandomMarker':
				...
				if ((_p46.ctor === 'Streaming') && (_p46._0 === true)) {
					var _p48 = _p46._1.markerDurations;
					...
					var updatedMarkerDurations = A2(
						...
						_p48) ? newMarkerDurations : A2(_elm_lang$core$Basics_ops['++'], newMarkerDurations, _p48);
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								state: A2(
									_connexity$ksql_web$Ksql_Common$Streaming,
									true,
									A2(_connexity$ksql_web$Ksql_Common$IndeterminateProgress, updatedMarkerDurations, _p46._1.currentTime))
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
...
var _connexity$ksql_web$Ksql_View$rowKeyType = function (schema) {
	return _elm_lang$core$List$head(
		A2(
			...
			function (row) {
				var _p7 = row;
				if ((((((_p7.ctor === '::') && (_p7._0.ctor === 'StringColumn')) && (_p7._0._0 === 'ROWKEY')) && (_p7._1.ctor === '::')) && (_p7._1._0.ctor === 'StringColumn')) && (_p7._1._1.ctor === '[]')) {
					if (_p7._1._0._0 === 'VARCHAR(STRING)') {
						return _elm_lang$core$Maybe$Just('STRING');
					} else {
						return _elm_lang$core$Maybe$Just(_p7._1._0._0);
					}
				} else {
					return _elm_lang$core$Maybe$Nothing;
				}
				...
				_0: _elm_lang$html$Html_Attributes$style(
					{
						...
						_0: {
							...
							_1: A2(
								_elm_lang$core$Basics_ops['++'],
								_elm_lang$core$Basics$toString(completion * 100),
								'%')
						},
						_1: {ctor: '[]'}
					}),
									...
									_0: A2(
										...
										},
										{
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('Link to this Query'),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}),
							...
							_0: A2(
								...
								},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('KSQL Syntax Reference'),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}),
															...
															function (marker, gapViews) {
																return {
																	...
																	_0: A2(
																		...
																		{
																			ctor: '::',
																			_0: _elm_lang$html$Html_Attributes$class('gap'),
																			_1: {
																				ctor: '::',
																				_0: _elm_lang$html$Html_Attributes$style(
																					{
										...
										case 'StreamingTabularResult':
											return {
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$class('data'),
														_1: {ctor: '[]'}
													},
													A3(
														_elm_lang$core$List$foldl,
														...
														_0: A2(
															...
															true,
															{
																...
																_1: {
																	...
																	_1: {
																		ctor: '::',
																		_0: _connexity$ksql_web$Ksql_Common$StringColumn('Local'),
																		_1: {
																			ctor: '::',
																			_0: _connexity$ksql_web$Ksql_Common$StringColumn('Overridden Value'),
																			_1: {ctor: '[]'}
																		}
																	}
																}
														...
														_1: A2(
															...
															function (_p12) {
																...
																return A2(
																	...
																	{
																		ctor: '::',
																		_0: _connexity$ksql_web$Ksql_Common$StringColumn(_p14),
																		_1: {
																			ctor: '::',
																			_0: _connexity$ksql_web$Ksql_Common$StringColumn(_p13._1),
																			_1: A2(_elm_lang$core$Dict$member, _p14, model.properties) ? {
																				ctor: '::',
																				_0: _connexity$ksql_web$Ksql_Common$BoolColumn(true),
																				_1: {
																					ctor: '::',
																					_0: A2(
																						_elm_lang$core$Maybe$withDefault,
																						_connexity$ksql_web$Ksql_Common$NullColumn,
																						A2(
																							_elm_lang$core$Maybe$map,
																							_connexity$ksql_web$Ksql_Common$StringColumn,
																							A2(_elm_lang$core$Dict$get, _p14, _p15))),
																					_1: {ctor: '[]'}
																				}
																			} : {
																				ctor: '::',
																				_0: _connexity$ksql_web$Ksql_Common$BoolColumn(false),
																				_1: {
																					ctor: '::',
																					_0: _connexity$ksql_web$Ksql_Common$NullColumn,
																					_1: {ctor: '[]'}
																				}
																			}
																		}
															...
															_elm_lang$core$Dict$toList(
																A2(_elm_lang$core$Dict$union, model.properties, _p15)))
													}),
												_1: {ctor: '[]'}
											};
										case 'DescribeExtendedResult':
											...
											return {
												...
												_0: _connexity$ksql_web$Ksql_View$metadataTableView(
													{
														ctor: '::',
														_0: {ctor: '_Tuple2', _0: 'Type', _1: _p16.schemaType},
														_1: {
															ctor: '::',
															_0: {ctor: '_Tuple2', _0: 'Key field', _1: _p16.key},
															_1: {
																ctor: '::',
																_0: {
																	ctor: '_Tuple2',
																	_0: 'Timestamp field',
																	_1: _elm_lang$core$String$isEmpty(_p16.timestamp) ? 'Not set - using <ROWTIME>' : _p16.timestamp
																},
																_1: {
																	ctor: '::',
																	_0: {
																		...
																		_1: A2(
																			_elm_lang$core$Maybe$withDefault,
																			'',
																			_connexity$ksql_web$Ksql_View$rowKeyType(_p16.schema))
																	},
																	_1: {
																		ctor: '::',
																		_0: {ctor: '_Tuple2', _0: 'Value format', _1: _p16.serdes},
																		_1: {
																			ctor: '::',
																			_0: {
																				ctor: '_Tuple2',
																				...
																				_1: A2(
																					_elm_lang$core$Basics_ops['++'],
																					_p16.kafkaOutputTopic.name,
																					A2(
																						_elm_lang$core$Basics_ops['++'],
																						' (partitions: ',
																						A2(
																							_elm_lang$core$Basics_ops['++'],
																							_elm_lang$core$Basics$toString(_p16.kafkaOutputTopic.partitions),
																							A2(
																								_elm_lang$core$Basics_ops['++'],
																								', replication: ',
																								A2(
																									_elm_lang$core$Basics_ops['++'],
																									_elm_lang$core$Basics$toString(_p16.kafkaOutputTopic.replication),
																									')')))))
																			},
																			_1: {ctor: '[]'}
																		}
												...
												_1: {
													...
													_1: {
														...
														_1: A2(
															_elm_lang$core$Basics_ops['++'],
															_elm_lang$core$List$isEmpty(_p16.writeQueries) ? {ctor: '[]'} : {
																ctor: '::',
																_0: A2(
																	...
																	{ctor: '[]'},
																	{
																		ctor: '::',
																		_0: _elm_lang$html$Html$text(
																			A2(_elm_lang$core$Basics_ops['++'], 'Queries that write into this ', _p16.schemaType)),
																		_1: {ctor: '[]'}
																	}),
																_1: A2(_connexity$ksql_web$Ksql_View$messagesView, _elm_lang$core$Maybe$Nothing, _p16.writeQueries)
															},
															A2(
																_elm_lang$core$Basics_ops['++'],
																{
																	...
																	_0: A2(
																		...
																		{
																			ctor: '::',
																			_0: _elm_lang$html$Html$text('For query topology and execution plan please run: EXPLAIN <QueryId>'),
																			_1: {ctor: '[]'}
																		}),
																	_1: {ctor: '[]'}
																},
																A2(
																	_elm_lang$core$Basics_ops['++'],
																	{
																		...
																		_0: A2(
																			...
																			{
																				ctor: '::',
																				_0: _elm_lang$html$Html$text('Local runtime statistics'),
																				_1: {ctor: '[]'}
																			}),
																		_1: {ctor: '[]'}
																	},
																					...
																					{ctor: '[]'},
																					{
																						...
																						_0: _elm_lang$html$Html$text(
																							A2(
																								...
																								A2(_elm_lang$core$Basics_ops['++'], _p16.kafkaOutputTopic.name, ')'))),
																						_1: {ctor: '[]'}
																					}),
																				_1: {ctor: '[]'}
																			})))))
												...
												_0: _connexity$ksql_web$Ksql_View$metadataTableView(
													{
														...
														_1: _elm_lang$core$String$isEmpty(_p17.statementText) ? {ctor: '[]'} : {
															ctor: '::',
															_0: {ctor: '_Tuple2', _0: 'SQL', _1: _p17.statementText},
															_1: {ctor: '[]'}
														}
													}),
												_1: A2(
																		...
																		{ctor: '[]'},
																		{
																			...
																			_0: _elm_lang$html$Html$text(
																				A2(
																					_elm_lang$core$Basics_ops['++'],
																					'(Statistics of the local KSQL server interaction with the Kafka topic ',
																					A2(_elm_lang$core$Basics_ops['++'], _p17.kafkaOutputTopic.name, ')'))),
																			_1: {ctor: '[]'}
																		}),
																	_1: {ctor: '[]'}
																},
																A2(
																	_elm_lang$core$Basics_ops['++'],
																	{
																		...
																		_0: A2(
																			...
																			{
																				ctor: '::',
																				_0: _elm_lang$html$Html$text('Execution plan'),
																				_1: {ctor: '[]'}
																			}),
																		_1: {ctor: '[]'}
																	},
																		...
																		A2(
																			_elm_lang$core$Basics_ops['++'],
																			{
																				...
																				_0: A2(
																					...
																					{
																						ctor: '::',
																						_0: _elm_lang$html$Html$text('Processing topology'),
																						_1: {ctor: '[]'}
																					}),
																				_1: {ctor: '[]'}
																			},
							...
							return A2(
								...
								function (secure) {
									return _elm_lang$core$Json_Decode$succeed(
										{host: host, queryHistory: queryHistory, search: search, secure: secure});
								},
...
if (typeof _connexity$ksql_web$Ksql_Common$main !== 'undefined') {
    _connexity$ksql_web$Ksql_Common$main(Elm['Ksql']['Common'], 'Ksql.Common', {"types":null,"versions":{"elm":"0.18.0"}});
}
Elm['Ksql'] = Elm['Ksql'] || {};
Elm['Ksql']['Init'] = Elm['Ksql']['Init'] || {};
if (typeof _connexity$ksql_web$Ksql_Init$main !== 'undefined') {
    _connexity$ksql_web$Ksql_Init$main(Elm['Ksql']['Init'], 'Ksql.Init', {"types":null,"versions":{"elm":"0.18.0"}});
}
Elm['Ksql'] = Elm['Ksql'] || {};
Elm['Ksql']['Port'] = Elm['Ksql']['Port'] || {};
if (typeof _connexity$ksql_web$Ksql_Port$main !== 'undefined') {
    _connexity$ksql_web$Ksql_Port$main(Elm['Ksql']['Port'], 'Ksql.Port', {"types":null,"versions":{"elm":"0.18.0"}});
}
Elm['Ksql'] = Elm['Ksql'] || {};
Elm['Ksql']['Subscriptions'] = Elm['Ksql']['Subscriptions'] || {};
if (typeof _connexity$ksql_web$Ksql_Subscriptions$main !== 'undefined') {
    _connexity$ksql_web$Ksql_Subscriptions$main(Elm['Ksql']['Subscriptions'], 'Ksql.Subscriptions', {"types":null,"versions":{"elm":"0.18.0"}});
}
Elm['Ksql'] = Elm['Ksql'] || {};
Elm['Ksql']['Update'] = Elm['Ksql']['Update'] || {};
if (typeof _connexity$ksql_web$Ksql_Update$main !== 'undefined') {
    _connexity$ksql_web$Ksql_Update$main(Elm['Ksql']['Update'], 'Ksql.Update', {"types":null,"versions":{"elm":"0.18.0"}});
}
Elm['Ksql'] = Elm['Ksql'] || {};
Elm['Ksql']['View'] = Elm['Ksql']['View'] || {};
if (typeof _connexity$ksql_web$Ksql_View$main !== 'undefined') {
    _connexity$ksql_web$Ksql_View$main(Elm['Ksql']['View'], 'Ksql.View', {"types":null,"versions":{"elm":"0.18.0"}});
}
Elm['Main'] = Elm['Main'] || {};
if (typeof _connexity$ksql_web$Main$main !== 'undefined') {
    _connexity$ksql_web$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Platform.Cmd.Cmd":{"args":["msg"],"tags":{"Cmd":[]}},"Ksql.Common.State":{"args":[],"tags":{"Idle":[],"Streaming":["Bool","Ksql.Common.IndeterminateProgress"],"Running":["Ksql.Common.DeterminateProgress"],"Initializing":["Ksql.Common.DeterminateProgress"]}},"Ksql.Common.Msg":{"args":[],"tags":{"ChangeQuery":["String"],"StopQuery":[],"SendWebSocketKeepAlive":["Time.Time"],"UsePrevQueryInHistory":[],"PauseQuery":[],"ProgressTick":["Time.Time"],"WebSocketIncoming":["String"],"RunQuery":[],"UpdateQueryHistory":["List String"],"ProgressAddRandomMarker":["Int"],"PerformInTimedState":["Platform.Cmd.Cmd Ksql.Common.Msg","Ksql.Common.State"],"UseNextQueryInHistory":[],"NoOp":[]}}},"aliases":{"Ksql.Common.IndeterminateProgress":{"args":[],"type":"{ markerDurations : List Time.Time, currentTime : Time.Time }"},"Ksql.Common.DeterminateProgress":{"args":[],"type":"{ duration : Time.Time, currentTime : Time.Time }"},"Time.Time":{"args":[],"type":"Float"}},"message":"Ksql.Common.Msg"},"versions":{"elm":"0.18.0"}});
}
Elm['Stream'] = Elm['Stream'] || {};
if (typeof _connexity$ksql_web$Stream$main !== 'undefined') {
    _connexity$ksql_web$Stream$main(Elm['Stream'], 'Stream', {"types":null,"versions":{"elm":"0.18.0"}});
}
